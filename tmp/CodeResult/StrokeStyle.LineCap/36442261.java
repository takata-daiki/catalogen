...
public class GWTCanvasImplDefault implements GWTCanvasImpl {
	...
	public native void drawImage(ImageElement img, double sourceX,
	...
	public native void drawImage(Element img, double sourceX, double sourceY,
	...
	private native void clearRect(double startX, double startY, double width,
			double height) /*-{   
