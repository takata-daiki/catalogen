...
public class ExcelBetreuerinZahlungenV {
	FileOutputStream fileOutputStream = null;

	public void erstelleExcel(ArrayList<String> spalten, String von, String bis) {
		try {

			fileOutputStream = new FileOutputStream("Betreuerinnen Vereinbarungsdatum.xlsx");
			...
			for (String spaltenname : spalten) {
				if (!spaltenname.equals("Vereinbarungsdatum")) {
			...
			headerCell00.setCellValue("Vereinbarungsdatum");
			...
			ArrayList<LinkedHashMap<String, Zahlungen>> sortierte_liste = sort
					.sortZahlungenBetreuerin("Vereinbarungsdatum",
			...
			for (int i = 0; i < sortierte_liste.size(); i++) {
				...
				spalten.remove("Vereinbarungsdatum");
