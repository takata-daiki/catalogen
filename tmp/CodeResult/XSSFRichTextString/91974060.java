...
public class ExcelBetreuerinZahlungenRN {
	FileOutputStream fileOutputStream = null;

	public void erstelleExcel(ArrayList<String> spalten, String von, String bis) {
		try {

			fileOutputStream = new FileOutputStream("Betreuerinnen Rechnungsnummer.xlsx");
			...
			for (String spaltenname : spalten) {
				if (!spaltenname.equals("Rechnungsnummer")) {
			...
			headerCell00.setCellValue("Rechnungsnummer");
			...
			ArrayList<LinkedHashMap<String, Zahlungen>> sortierte_liste = sort
					.sortZahlungenBetreuerin("Rechnungsnummer",
			...
			for (int i = 0; i < sortierte_liste.size(); i++) {
				...
				spalten.remove("Rechnungsnummer");
