...
public class EvaluateTemplate extends AbstractAnnotatedTemplate {
    ...
    public void addProperty(PropertyTemplate template) {
    ...
    @Override
    public Object clone() {
    	EvaluateTemplate template = (EvaluateTemplate)super.clone();
    	
    	template.properties = new ArrayList<PropertyTemplate>();
