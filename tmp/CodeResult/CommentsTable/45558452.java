...
//			}
	...
	public ObjectLiteralField convert(org.eclipse.wst.jsdt.internal.compiler.ast.ObjectLiteralField field) {
		...
		if (objectLiteralField.getInitializer() instanceof FunctionExpression && field.getJsDoc() != null) {
			FunctionExpression fe = (FunctionExpression) objectLiteralField.getInitializer();
			convert(field.javaDoc, fe.getMethod());
		}
