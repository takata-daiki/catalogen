...
public class KeywordToexcel{
	public static void main(String args[]) throws IOException{
        ...
        //一个样式
	        ...
	        e.setCell(0,"host关键字",columnHeadStyle);
	        ...
	        e.setCell(0,"搜索关键字",columnHeadStyle);
	        ...
	        e.setCell(3,"主机名",columnHeadStyle,100);
	        e.setCell(4,"时间",columnHeadStyle,100);
	        e.setCell(5,"搜索关键字",columnHeadStyle,100);
