/************************************************************************
  Blob.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
public class Blob extends EventDispatcher {
    ...
    public native Size getImageFileDimensions() /*-{
		...
		if (blob.width && blob.height) {
			...
			var toReturn = @com.emitrom.ti4j.mobile.client.core.Size::new();
			return toReturn;
		}
    }-*/;
    ...
    public native Blob imageAsCropped(int x, int y, int height, int width) /*-{
		...
		var toReturn = @com.emitrom.ti4j.mobile.client.blob.Blob::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ret);
		return toReturn;
    }-*/;
