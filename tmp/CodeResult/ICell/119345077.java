...
public class RadReadPDFScreen extends XDATScreen_pdf {
	 XFTItem item = null;
	...
	protected ByteArrayOutputStream buildPdf (RunData data) throws 	Exception {
		...
		HeaderFooter footer  = new HeaderFooter(new Phrase("Document Production Date: " + dateFormat.format(now),new Font(Font.TIMES_ROMAN,9,Font.BOLD)),false);
		    ...
		    table.addCell(makeCell("Date of Birth:",new Font(Font.TIMES_ROMAN,10,Font.BOLD))); table.addCell(makeCell(ydateFormat.format(mr.getSubjectData().getDOB()),new Font(Font.TIMES_ROMAN,10,Font.NORMAL)));
