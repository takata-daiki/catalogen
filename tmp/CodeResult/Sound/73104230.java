/************************************************************************
  Sound.java is part of Ti4j 3.1.0  Copyright 2013 Emitrom LLC
...
import com.emitrom.ti4j.mobile.client.core.handlers.media.audio.SoundCompleteHandler;
import com.emitrom.ti4j.mobile.client.core.handlers.media.audio.SoundResumeHandler;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * The sound object is returned by
 * {@link com.emitrom.ti4j.mobile.client.media.Media.createSound} and is
 ...
 * {@link com.emitrom.ti4j.mobile.client.media.Media.createAudioplayer} API.
 * <p>
    ...
    public native void addCompleteHandler(SoundCompleteHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.media.audio.SoundCompleteEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.audio.SoundCompleteHandler::onSoundComplete(Lcom/emitrom/ti4j/mobile/client/core/events/media/audio/SoundCompleteEvent;)(eventObject);
						});
    }-*/;
    ...
    public native void addResumeHandler(SoundResumeHandler handler)/*-{
		...
		jso
				.addEventListener(
						...
						function(e) {
							var eventObject = @com.emitrom.ti4j.mobile.client.core.events.media.audio.SoundResumeEvent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
							handler.@com.emitrom.ti4j.mobile.client.core.handlers.media.audio.SoundResumeHandler::onSoundResume(Lcom/emitrom/ti4j/mobile/client/core/events/media/audio/SoundResumeEvent;)(eventObject);
						});
    }-*/;
