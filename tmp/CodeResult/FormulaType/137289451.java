 ...
 * Copyright (C) 2012-2013 XCalc Team
 * 
...
public abstract class Atom {
	...
	public Atom(FORMULA_ELEMENT_TYPE formulaType) {
	...
	/**
	 * Save a previously calculated box to speed up rendering. This method
	 * should be called in every implementation of the {@link
	 * #createBox(TeXEnvironment)} method.
	 */
	protected void cacheBox(final Box box) {
		changed = false;
		cachedBox = box;
	}

	/**
	 * Invalidate the box associated with this atom.
	 */
	...
	/**
	 * Invalidate the box associated with this atom and all boxes associated
	 * with descendants of this atom.
	 */
	public abstract void invalidateAll();

	/**
	 * Retrieve the cached box of this atom.
	 */
	...
	/**
	 * Tests whether the box of this atom has to be recalculated.
	 */
	public boolean isCachedBoxValid() {
		return !changed;
	}

	public abstract <T> void accept(T context, final FormulaVisitor<T> visitor);
