...
public abstract class Controller implements ControllerInterface, CDrawable, ControlP5Constants {
	...
	public CVector3f positionBuffer;

	public CVector3f absolutePosition;

	public ControllerInterface _myParent;

	public String _myName;

	public ControlWindow _myControlWindow;
	...
	public float _myDefaultValue;

	public String _myStringValue = "";

	public float[] _myArrayValue;

	public Label _myCaptionLabel;

	public Label _myValueLabel;
	...
	public List<ControlListener> _myControlListener;
	...
	public float _myUnit;

	public List<ControllerPlug> _myControllerPlugList;

	public String target;

	public Object targetObject;

	public ControlBehavior _myBehavior;

	public boolean isBehavior;

	public boolean isXMLsavable = true;

	public List<Controller> subelements;

	public int myBroadcastType = FLOAT;

	public boolean isUpdate = false;

	public int _myDecimalPoints = 2;

	public ControllerSprite sprite;

	public boolean isSprite;

	public int autoWidth = 50;

	public int autoHeight = 20;

	public CVector3f autoSpacing = new CVector3f(10, 10, 0);

	public boolean isLock = false;

	public boolean isUserInteraction = true;

	public boolean[] availableImages = new boolean[4];

	public PImage[] images = new PImage[4];

	public ControllerDisplay _myDisplay;

	public ControllerDisplay _myDebugDisplay;

	public int _myDisplayMode = DEFAULT;

	public int _myPickingColor = 0xffffff00;
	...
	public Controller(final int theX, final int theY) {
		position = new CVector3f(theX, theY, 0);
	}
	...
	public ControllerPlug controllerPlug(int theIndex) {
	...
	public void removeControllerPlug(final ControllerPlug thePlug) {
	...
	public void broadcast(int theType) {
	 ...
	 * @return String
	 */
	public String adjustValue(final float theValue) {
	 ...
	 * @return
	 */
	public String adjustValue(final float theValue, final int theFloatPrecision) {
