...
public class Slider extends Controller {
	...
	public int _mySliderMode = FIX;

	public float _myValuePosition;

	public float _mySliderbarSize = 0;

	public ArrayList<TickMark> _myTickMarks;

	public boolean isShowTickMarks;

	public boolean isSnapToTickMarks;

	public static int autoWidth = 150;
	...
	public void snapValue(float theValue) {
