...
public class Range extends Controller {
	...
	public int _myDirection;

	public final static int FIX = 1;

	public final static int FLEXIBLE = 0;

	public int _mySliderMode = FLEXIBLE;

	public float _myValuePosition;
	...
	public Label _myHighValueLabel;

	public float _myValueRange;

	public boolean isMinHandle;

	public boolean isMaxHandle;

	public boolean isMoveHandle;

	public float distanceHandle;

	public int handleSize = 10;

	public float minHandle = 0;

	public float maxHandle = 0;

	public Vector<TickMark> _myTickMarks;

	public boolean isShowTickMarks;

	public boolean isSnapToTickMarks;

	public static int autoWidth = 200;

	public static int autoHeight = 10;

	public static CVector3f autoSpacing = new CVector3f(0, 5, 0);
