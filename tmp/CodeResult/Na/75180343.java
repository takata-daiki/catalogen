    ...
    public void erroBugzilla() {
        try {
            ...
            if (erro != null) {
                ...
                int execucao = TestlinkUtils.reportaResultadoExecucao("ALM TDC2012","Plano Regresso", "Login com Sucesso", "Erro na execuo do teste", String.valueOf(bugID));
                ...
                // reporta o resultado do caso de teste no Testlink
                TestlinkUtils.reportaResultadoExecucao("ALM TDC2012","Plano Regresso", "Login com Sucesso", "Teste executado com sucesso", null);               
            }
        }
    }    
