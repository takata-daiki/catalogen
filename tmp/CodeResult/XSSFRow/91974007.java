...
public class ExcelBetreuerinBetreuungAU {
	FileOutputStream fileOutputStream = null;

	public void erstelleExcel(ArrayList<String> spalten, String von, String bis) {
		try {

			fileOutputStream = new FileOutputStream("Betreuerinnen Aufgehรถrt.xlsx");
			...
			for (String spaltenname : spalten) {
				if (!spaltenname.equals("Aufgehort")) {
			...
			headerCell00.setCellValue("Aufgehort");
			...
			ArrayList<LinkedHashMap<String, Betreuung>> sortierte_liste = sort
					.sortBetreuungBetreuerin("Aufgehรถrt", betreuerinnen, von, bis);
