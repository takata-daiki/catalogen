 ...
 */
public final class Factory extends org.mmtk.vm.FactoryDSU {
  ...
  /**
   * Create a new Dsu instance using the appropriate VM-specific
   * concrete Dsu sub-class.
   *
   * @see Dsu
   * @return A concrete VM-specific Dsu instance.
   */
  public org.mmtk.vm.Dsu newDsu() {
    try {
      return new Dsu();
    } catch (Exception e) {
      VM.sysFail("Failed to allocate new Dsu!");
      return null; // never get here
    }
  }
  ...
  /**
   * Create a new ObjectModelDSU instance using the appropriate VM-specific
   * concrete ObjectModelDSU sub-class.
   *
   * @see ObjectModelDSU
   * @return A concrete VM-specific ObjectModelDSU instance.
   */
  public org.mmtk.vm.ObjectModelDSU newObjectModelDSU() {
    try {
      return new ObjectModelDSU();
    } catch (Exception e) {
      VM.sysFail("Failed to allocate new ObjectModelDSU!");
      return null; // never get here
    }
  }
