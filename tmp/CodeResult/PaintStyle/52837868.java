...
public final class VM {
  ...
  @Untraced
  public static final Dsu dsu;
  @Untraced
  public static final ObjectModel objectModel;
  @Untraced
  public static final ObjectModelDSU objectModelDSU;
  @Untraced
   ...
   * classes.
   */
  private static final FactoryDSU factory;
  ...
  static {
    ...
    FactoryDSU xfa = null;
    try {
      xfa = (FactoryDSU) Class.forName(vmFactory).newInstance();
    } catch (Exception e) {
      e.printStackTrace();
    ...
    objectModelDSU = factory.newObjectModelDSU();
