...
class ChartText implements OOXMLElement {
	...
	public int getFontId(WorkBookHandle wb) {
		...
		if (bpr != null) {
			/*
			 * noAutofit (No AutoFit) ยง5.1.5.1.2 normAutofit (Normal AutoFit)
			 * ยง5.1.5.1.3 prstTxWarp (Preset Text Warp) ยง5.1.11.19 scene3d (3D
			 * Scene Properties) ยง5.1.4.1.26 sp3d (Apply 3D shape properties)
			 * ยง5.1.7.12 spAutoFit (Shape AutoFit)
			 */
