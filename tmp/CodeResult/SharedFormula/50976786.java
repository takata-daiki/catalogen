...
*/
    ...
    */
    ...
    /**
       ...
       @param address
       @param d
       @exception com.extentech.formats.XLS.CellNotFoundException is
    ...
    */
    ...
    /**
       ...
       @exception com.extentech.formats.XLS.CellNotFoundException
	...
	*/    
	...
	boolean deleteRow(int rownum, int flag, boolean shiftrows){
		...
		private boolean shiftRow(int rownum,
			...
			Row newRow = mysheet.insertRow(rownum, flag, shiftrows);	// shifts rows down and inserts a new row, also shifts shared formula refs (see note below) 			
	...
	*/
	...
	throws IOException {
		...
		String field_delimiter = System.getProperty(
				"com.extentech.extenxls.csvdelimiter", ",");
