...
public class ExcelBetreuerinZahlungenB {
	FileOutputStream fileOutputStream = null;

	public void erstelleExcel(ArrayList<String> spalten, String von, String bis) {
		try {

			fileOutputStream = new FileOutputStream("Betreuerinnen Bezahldatum.xlsx");
			...
			for (String spaltenname : spalten) {
				if (!spaltenname.equals("Bezahldatum")) {
			...
			headerCell00.setCellValue("Bezahldatum");
			...
			ArrayList<LinkedHashMap<String, Zahlungen>> sortierte_liste = sort
					.sortZahlungenBetreuerin("Bezahldatum",
