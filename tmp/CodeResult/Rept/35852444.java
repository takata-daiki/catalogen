...
public class LockScreenActivity extends FragmentActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mTracker = new AnalyticsHelper(this);
        mTracker.startNewSession();
        mTracker.trackPageView(AnalyticsConsts.PAGE_LOCKSCREEN_ACTIVITY);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
        case R.id.btnRew: {
            mTracker.trackClick("onClick.rew");
            rew();
        }
            break;
        case R.id.btnPlay: {
            mTracker.trackClick("onClick.play");
            play();
        }
            break;
        case R.id.btnFf: {
            mTracker.trackClick("onClick.ff");
            ff();
        }
            break;
        case R.id.btnSfl: {
            mTracker.trackClick("onClick.shuffle");
            sfl();
        }
            break;
        case R.id.btnRept1: {
            mTracker.trackClick("onClick.repeat1");
            rept();
        }
            break;
