...
public interface PropertyValue<T> extends Cloneable, Serializable, LayoutMLConstants {
	...
	/**
	 * Returns the Value in a specific Class.
	 * <br>
	...
	/**
	 * This Method returns a modified {@link TableCellEditor} for display 
	 * in the {@link PropertiesPanel}.
	 * <br>
	 * It is for <b>editing</b> the Values and may be complex (like 
	 * {@link JPanel} with a {@link JTextField}, a {@link JLabel} and a {@link JButton})
	 * 
