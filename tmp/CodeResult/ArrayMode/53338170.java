...
import hqextdirect.json.processors.DefaultDefaultValueProcessor;
import hqextdirect.json.processors.DefaultValueProcessor;
import hqextdirect.json.processors.DefaultValueProcessorMatcher;
import hqextdirect.json.processors.JsonBeanProcessor;
import hqextdirect.json.processors.JsonBeanProcessorMatcher;
import hqextdirect.json.processors.JsonValueProcessor;
import hqextdirect.json.processors.JsonValueProcessorMatcher;
import hqextdirect.json.processors.PropertyNameProcessor;
import hqextdirect.json.processors.PropertyNameProcessorMatcher;
import hqextdirect.json.util.CycleDetectionStrategy;
import hqextdirect.json.util.JavaIdentifierTransformer;
import hqextdirect.json.util.JsonEventListener;
import hqextdirect.json.util.NewBeanInstanceStrategy;
import hqextdirect.json.util.PropertyExclusionClassMatcher;
import hqextdirect.json.util.PropertyFilter;
import hqextdirect.json.util.PropertySetStrategy;
...
public class JsonConfig {
   ...
   private static final String[] DEFAULT_EXCLUDES = new String[] { "declaringClass", "metaClass" };
