...
public class TableTag extends HtmlTableTag {
    ...
    /**
     * Sets the content of the header. Called by a nested footer tag.
     *
     * @param string header content
     */
    public void setHeader(String string) {
        this.header = string;
        this.tableModel.setHeader(this.header);
    }
     ...
     *
     * @return int
     * @throws javax.servlet.jsp.JspException generic exception
     ...
     *
     * @throws org.displaytag.exception.FactoryInstantiationException for problems in instantiating a RequestHelperFactory
     */
     ...
     * @throws javax.servlet.jsp.JspException for problem in clearing the response or for invalid export views
     * @throws java.io.IOException  exception thrown when writing content to the response
     */
