...
public class Toexcel{
	public static void main(String args[]) throws IOException{
	    ...
	    String sDate=args[3];
	    String flow_name=args[4];

		XLSCreate e=new XLSCreate("/datacenter/msa/report/msaexport/srvrecord/srvexport.xls");
        //字体
        ...
        //一个样式
	        ...
	        e.setCell(0,"服务汇总记录查询",headstyle);
	        ...
	        e.setCell(0,"服务类型",columnHeadStyle);
	        ...
	        e.setCell(0,"流量范围",columnHeadStyle);
	        e.setCell(1,flow_name,style);
	        ...
	        e.setCell(1,"用户名",columnHeadStyle,100);
	        e.setCell(2,"部门",columnHeadStyle,100);
	        e.setCell(3,"日期",columnHeadStyle,100);
	        e.setCell(4,"服务",columnHeadStyle,100);
	        e.setCell(5,"上流量",columnHeadStyle,100);
	        e.setCell(6,"下流量",columnHeadStyle,100);
	        e.setCell(7,"连接次数",columnHeadStyle,100);
	        e.setCell(8,"连接时长",columnHeadStyle,100);
	        
	        int rownum=0;      
	        BufferedReader reader = null;
	        String line = null;
		    reader = new BufferedReader(new FileReader("/datacenter/msa/report/msaexport/srvrecord/srvexport.csv"));	     
