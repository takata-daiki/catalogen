...
package com.infinitegraph.samples.ighunter.util;
...
public final class Range<T extends Comparable<T>>
{
			...
			throws IllegalArgumentException
	{
		...
		if (this.lowerBound != null
				&& (range.lowerBound == null || range.lowerBound
						.compareTo(this.lowerBound) < 0))
			return false;

		if (this.upperBound != null
				&& (range.upperBound == null || range.upperBound
			...
			throws IllegalArgumentException
	{
		...
		if (this.upperBound != null && range.lowerBound != null
				&& this.upperBound.compareTo(range.lowerBound) < 0)
			return false;

		if (this.lowerBound != null && range.upperBound != null
				&& this.lowerBound.compareTo(range.upperBound) > 0)
			return false;
	...
	public final int hashCode()
	{
		...
		final int lowerBoundHashCode = this.lowerBound == null ? MAX_VALUE
				: this.lowerBound.hashCode();

		// MIN_value is used for open UPPER bound as it will be most far away
		// from any existing UPPER bound.
		final int upperBoundHashCode = this.upperBound == null ? MIN_VALUE
	...
	public final boolean equals(final Object other)
	{
		...
		return equals(this.lowerBound, that.lowerBound)
