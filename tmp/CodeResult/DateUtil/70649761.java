/**************************************************************************
 * DateUtil.java is part of Touch4j 4.0. Copyright 2012 Emitrom LLC
 * 
...
public class DateUtil {
    ...
    public static native String format(Date date, String format) /*-{
		if (date == null)
			return "";
		var millis = @com.emitrom.touch4j.client.utils.DateUtil::getTime(Ljava/util/Date;)(date);
    ...
    public static native Date parseDate(String input, String format)/*-{
        ...
        return @com.emitrom.touch4j.client.utils.DateUtil::create(D)(date.getTime());
    }-*/;
    ...
    public static native Date add(Date date, Interval interval, int value)/*-{
        var intervalJS = interval.@com.emitrom.touch4j.client.utils.DateUtil.Interval::getInterval()();
        var millis = @com.emitrom.touch4j.client.utils.DateUtil::getTime(Ljava/util/Date;)(date);
        var dateJS = new $wnd.Date(millis);
        var newDate = dateJS.add(intervalJS, value);
        return  @com.emitrom.touch4j.client.utils.DateUtil::create(D)(newDate.getTime());
    }-*/;
