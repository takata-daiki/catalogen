...
public class TFileInputExcelBeginJava
{
  ...
  protected final String TEXT_390 = "];" + NL + "\t\t\tint excel_end_column_";
  protected final String TEXT_391 = ";" + NL + "\t\t\tif(row_";
  protected final String TEXT_392 = "==null){" + NL + "\t\t\t\texcel_end_column_";
  protected final String TEXT_393 = "=0;" + NL + "\t\t\t}else{" + NL + "\t\t\t\texcel_end_column_";
  protected final String TEXT_394 = "=row_";
  protected final String TEXT_395 = ".getLastCellNum();" + NL + "\t\t\t}" + NL + "\t\t\tint actual_end_column_";
  protected final String TEXT_396 = ";" + NL + "\t\t\tif(end_column_";
  protected final String TEXT_397 = " == -1){" + NL + "\t\t\t\tactual_end_column_";
  protected final String TEXT_398 = " = excel_end_column_";
  protected final String TEXT_399 = ";" + NL + "\t\t\t}" + NL + "\t\t\telse{" + NL + "\t\t\t\tactual_end_column_";
  protected final String TEXT_400 = " = end_column_";
  protected final String TEXT_401 = " >\texcel_end_column_";
  protected final String TEXT_402 = " ? excel_end_column_";
  protected final String TEXT_403 = " : end_column_";
  protected final String TEXT_404 = ";" + NL + "\t\t\t}" + NL + "\t\t\tfor(int i=0;i<";
  protected final String TEXT_405 = ";i++){" + NL + "\t\t\t\tif(i + start_column_";
  protected final String TEXT_406 = " < actual_end_column_";
  protected final String TEXT_407 = "){" + NL + "\t\t\t\t\torg.apache.poi.ss.usermodel.Cell cell_";
  protected final String TEXT_408 = " = row_";
  protected final String TEXT_409 = ".getCell(i + start_column_";
  protected final String TEXT_410 = ");" + NL + "\t\t\t\t\tif(cell_";
  protected final String TEXT_411 = "!=null){" + NL + "\t\t\t\t\tswitch (cell_";
  protected final String TEXT_412 = ".getCellType()) {" + NL + "                        case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_STRING:" + NL + "                            temp_row_";
  protected final String TEXT_413 = "[i] = cell_";
  protected final String TEXT_414 = ".getRichStringCellValue().getString();" + NL + "                            break;" + NL + "                        case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC:" + NL + "                            if (org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(cell_";
  protected final String TEXT_415 = ")) {" + NL + "                                temp_row_";
  protected final String TEXT_416 = "[i] =cell_";
  protected final String TEXT_417 = ".getDateCellValue().toString();" + NL + "                            } else {" + NL + "                                temp_row_";
  protected final String TEXT_418 = "[i] = df_";
  protected final String TEXT_419 = ".format(cell_";
  protected final String TEXT_420 = ".getNumericCellValue());" + NL + "                            }" + NL + "                            break;" + NL + "                        case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_BOOLEAN:" + NL + "                            temp_row_";
  protected final String TEXT_421 = "[i] =String.valueOf(cell_";
  protected final String TEXT_422 = ".getBooleanCellValue());" + NL + "                            break;" + NL + "                        case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_FORMULA:" + NL + "        \t\t\t\t\tswitch (cell_";
  protected final String TEXT_423 = ".getCachedFormulaResultType()) {" + NL + "                                case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_STRING:" + NL + "                                    temp_row_";
  protected final String TEXT_424 = "[i] = cell_";
  protected final String TEXT_425 = ".getRichStringCellValue().getString();" + NL + "                                    break;" + NL + "                                case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC:" + NL + "                                    if (org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(cell_";
  protected final String TEXT_426 = ")) {" + NL + "                                        temp_row_";
  protected final String TEXT_427 = "[i] =cell_";
  protected final String TEXT_428 = ".getDateCellValue().toString();" + NL + "                                    } else {" + NL + "                                         temp_row_";
  protected final String TEXT_429 = "[i] = df_";
  protected final String TEXT_430 = ".format(numberFormat_";
  protected final String TEXT_431 = ".parse(dataFormat_";
  protected final String TEXT_432 = ".formatCellValue(cell_";
  protected final String TEXT_433 = ",workbook_";
  protected final String TEXT_434 = ".getCreationHelper().createFormulaEvaluator())));" + NL + "                                    }" + NL + "                                    break;" + NL + "                                case org.apache.poi.ss.usermodel.Cell.CELL_TYPE_BOOLEAN:" + NL + "                                    temp_row_";
  protected final String TEXT_435 = "[i] =String.valueOf(cell_";
  protected final String TEXT_436 = ".getBooleanCellValue());" + NL + "                                    break;" + NL + "                                default:" + NL + "                            \t\ttemp_row_";
  protected final String TEXT_437 = "[i] = \"\";" + NL + "                            }" + NL + "                            break;" + NL + "                        default:" + NL + "                            temp_row_";
  protected final String TEXT_438 = "[i] = \"\";" + NL + "                        }" + NL + "                \t}" + NL + "                \telse{" + NL + "                \t\ttemp_row_";
  protected final String TEXT_439 = "[i]=\"\";" + NL + "                \t}" + NL + "\t\t\t\t\t" + NL + "\t\t\t\t}else{" + NL + "\t\t\t\t\ttemp_row_";
  protected final String TEXT_440 = "[i]=\"\";" + NL + "\t\t\t\t}\t\t\t\t\t\t\t\t" + NL + "\t\t\t}" + NL + "\t\t\tboolean whetherReject_";
  protected final String TEXT_441 = " = false;" + NL + "\t\t\t";
  protected final String TEXT_442 = " = new ";
  protected final String TEXT_443 = "Struct();" + NL + "\t\t\tint curColNum_";
  protected final String TEXT_444 = " = -1;" + NL + "\t\t\tString curColName_";
  protected final String TEXT_445 = " = \"\";" + NL + "\t\t\ttry{";
  protected final String TEXT_446 = NL + "\t\t\tif(temp_row_";
  protected final String TEXT_447 = "[";
  protected final String TEXT_448 = "]";
  protected final String TEXT_449 = ".length() > 0) {" + NL + "\t\t\t\tcurColNum_";
  protected final String TEXT_450 = "=";
  protected final String TEXT_451 = " + start_column_";
  protected final String TEXT_452 = " + 1;" + NL + "\t\t\t\tcurColName_";
  protected final String TEXT_453 = " = \"";
  protected final String TEXT_454 = "\";" + NL + "\t\t\t\t\t\t\t\t";
  protected final String TEXT_455 = "\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_456 = ".";
  protected final String TEXT_457 = " = temp_row_";
  protected final String TEXT_458 = "[";
  protected final String TEXT_459 = "]";
  protected final String TEXT_460 = ";";
  protected final String TEXT_461 = "\t\t" + NL + "\t\t\t\tif(";
  protected final String TEXT_462 = "<actual_end_column_";
  protected final String TEXT_463 = "){" + NL + "\t\t\t\t\ttry{" + NL + "\t\t\t\t\t\tif(row_";
  protected final String TEXT_464 = ".getCell(";
  protected final String TEXT_465 = "+ start_column_";
  protected final String TEXT_466 = ").getCellType() == org.apache.poi.ss.usermodel.Cell.CELL_TYPE_NUMERIC && org.apache.poi.ss.usermodel.DateUtil.isCellDateFormatted(row_";
  protected final String TEXT_467 = ".getCell(";
  protected final String TEXT_468 = "+ start_column_";
  protected final String TEXT_469 = "))){" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_470 = ".";
  protected final String TEXT_471 = " = row_";
  protected final String TEXT_472 = ".getCell(";
  protected final String TEXT_473 = "+ start_column_";
  protected final String TEXT_474 = ").getDateCellValue();" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t\telse{" + NL + "\t\t\t\t\t\t\t";
  protected final String TEXT_475 = ".";
  protected final String TEXT_476 = " = ParserUtils.parseTo_Date(temp_row_";
  protected final String TEXT_477 = "[";
  protected final String TEXT_478 = "]";
  protected final String TEXT_479 = ", ";
  protected final String TEXT_480 = ");" + NL + "\t\t\t\t\t\t}" + NL + "\t\t\t\t\t}catch(Exception e){" + NL + "\t\t\t\t\t\t";
  protected final String TEXT_481 = NL + "\t\t\t\t\t\tthrow new RuntimeException(\"The cell format is not Date in ( Row. \"+(nb_line_";
  protected final String TEXT_482 = "+1)+ \" and ColumnNum. \" + curColNum_";
  protected final String TEXT_483 = " + \" )\");" + NL + "\t\t\t\t\t}" + NL + "\t\t\t\t}" + NL + "\t\t\t\t";
  protected final String TEXT_484 = NL + "\t\t\t\t";
  protected final String TEXT_485 = ".";
  protected final String TEXT_486 = " = ParserUtils.parseTo_";
  protected final String TEXT_487 = "(ParserUtils.parseTo_Number(temp_row_";
  ...
  protected final String TEXT_495 = " = ParserUtils.parseTo_";
  protected final String TEXT_496 = "(ParserUtils.parseTo_Number(temp_row_";
  protected final String TEXT_497 = "[";
  protected final String TEXT_498 = "]";
  protected final String TEXT_499 = ", null, '.'==decimalChar_";
  protected final String TEXT_500 = " ? null : decimalChar_";
  protected final String TEXT_501 = "));";
  protected final String TEXT_502 = "\t\t\t\t\t\t\t" + NL + "\t\t\t\t";
  protected final String TEXT_503 = ".";
  protected final String TEXT_504 = " = temp_row_";
  protected final String TEXT_505 = "[";
  protected final String TEXT_506 = "]";
  protected final String TEXT_507 = ".getBytes(";
  ...
  protected final String TEXT_517 = NL + "\t\t\t\t\tthrow new RuntimeException(\"Value is empty for column : '";
  protected final String TEXT_518 = "' in '";
  protected final String TEXT_519 = "' connection, value is invalid or this column should be nullable or have a default value.\");";
  protected final String TEXT_520 = NL + "\t\t\t\t";
  protected final String TEXT_521 = ".";
  protected final String TEXT_522 = " = ";
  protected final String TEXT_523 = ";" + NL + "\t\t\t\temptyColumnCount_";
  protected final String TEXT_524 = "++;";
  protected final String TEXT_525 = NL + "\t\t\t}";
  protected final String TEXT_526 = " ";
  protected final String TEXT_527 = " = null; ";
  protected final String TEXT_528 = NL;
  protected final String TEXT_529 = NL + "        if(emptyColumnCount_";
  protected final String TEXT_530 = " == ";
  protected final String TEXT_531 = "){" + NL + "        \tbreak; //if meet the empty row, there will break the iterate." + NL + "        }";
  protected final String TEXT_532 = "  " + NL + "\t\t\t}catch(Exception e){" + NL + "\t\t\twhetherReject_";
  protected final String TEXT_533 = " = true;";
  protected final String TEXT_534 = NL + "\t            throw(e);";
  protected final String TEXT_535 = NL + "\t\t\t\t\t";
  protected final String TEXT_536 = " = new ";
  protected final String TEXT_537 = "Struct();";
  ...
  protected final String TEXT_544 = ".errorMessage = e.getMessage() + \" - Line: \" + tos_count_";
  protected final String TEXT_545 = "+ \" column: \" + curColName_";
  protected final String TEXT_546 = " + \" (No. \" + curColNum_";
  protected final String TEXT_547 = " + \")\";" + NL + "\t\t\t\t\t";
  protected final String TEXT_548 = " = null;";
  protected final String TEXT_549 = NL + "\t\t\t\t\t System.err.println(e.getMessage());" + NL + "\t\t\t\t\t ";
