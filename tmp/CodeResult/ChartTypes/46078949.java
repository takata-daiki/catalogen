...
/**
 * This Class is for editing the {@link WYSIWYGProperty} used for {@link WYSIWYGChart}.
 * 
 * 
 * <br>
...
public class PropertyChartPropertyChartStep extends PanelWizardStep implements Closeable {
	...
	private final WYSIWYGProperty wysiywygProperty;
	...
	public PropertyChartPropertyChartStep(WYSIWYGProperty wysiywygProperty) {
	...
	private ChartFunction getChartFunction() {
		for (WYSIWYGPropertySet propertySet : wysiywygProperty.properties) {
	...
	public void init(WizardModel model) {
		...
		// store chart type.
		for (WYSIWYGPropertySet propertySet : ((PropertyChartProperty)this.model.getWYSIWYGChart().getProperties().getProperty(WYSIWYGChart.PROPERTY_PROPERTIES)).getValue().properties) {
			if (propertySet.getPropertyName().equals(Chart.PROPERTY_TYPE)) {
				wysiywygProperty.addWYSIYWYGPropertySet(
						new WYSIWYGPropertySet(Chart.PROPERTY_TYPE,
				...
				if (chartTypes[i].getType().equals(chartFunction.name())) {
					if (chartTypes[i].getType().equals(chartFunction.name())) {
						...
						SwingUtilities.invokeLater(new Runnable() {
							@Override
							public void run() {
								list.setSelectedValue(chartTypes[j], true);
							}
						});
			        	break;
					}
