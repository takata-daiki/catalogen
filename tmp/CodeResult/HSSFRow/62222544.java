  ...
  **/
  ...
  try {
   //??????????inputstream????HSSFWordbook??
        HSSFWorkbook hssfworkbook = new HSSFWorkbook(new FileInputStream("e:/jiaoshixinxi.xls"));
...
//                     }
                     ...
                     xydh = hssfrow.getCell(2).getStringCellValue().trim();
