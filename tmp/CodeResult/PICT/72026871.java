...
public class HttpUtil {
	...
	private static final Map<String,String> mimeTypeExt = new HashMap<String,String>(){
		/**
		 * 
		 */
		private static final long serialVersionUID = -4862189225986297751L;

		{
			...
			put(".dwf","model/vndput.dwf");
			put(".dwg","application/acad");
			put(".dwg","image/vndput-dwg");
			put(".dwg","image/x-dwg");
	...
	public static <B extends java.io.Serializable> String convertToUrl(B bean,
			Map<String, Object> parameterMap) {

		if (parameterMap == null)
			return "";
		StringBuffer sb = new StringBuffer();
		for (Entry<String, Object> pentry : parameterMap.entrySet()) {
	...
	public static String extToMimeType(String ext){
		
		ext = ext!=null?ext.toLowerCase():"txt";
		if(ext.startsWith("."))return mimeTypeExt.get(ext);
		else return mimeTypeExt.get("."+ext);
	}
