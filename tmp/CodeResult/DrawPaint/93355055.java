...
public class DrawingView extends View {
	...
	public void drawBitmap(Bitmap p){
	...
	public void rot(){
		drawCanvas.save();
		drawCanvas.translate(drawCanvas.getWidth(), 0 );
		drawCanvas.rotate((float) 90.0);
		drawCanvas.translate(0, drawCanvas.getHeight() );
		drawCanvas.drawPoint(10, 10, canvasPaint);
		drawCanvas.restore();
}
