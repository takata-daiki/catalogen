...
public class BusinessGroupPropertyManager extends BasicManager {
	 ...
	 */
	public Property createAndPersistDisplayMembers(final boolean showOwners, final boolean showPartips, final boolean showWaitingList) {
		long showXXX = 0;
		if (showOwners) {
		...
		final Property prop = npm.createPropertyInstance(null, this.businessGroup, PropertyConstants.OLATRESOURCE_CONFIGURATION, PROP_NAME, null, new Long(showXXX),
				null, null);
