...
public class Evaluations {
	 ...
	 * 
	 * @param instructions the instructions for the evaluation (Pre-condition:
	 *        Must not be null)
	 * 
	 * @param commentsEnabled if students are allowed to make comments
	 *        (Pre-condition: Must not be null)
	 * 
	 * @param start the start date/time of the evaluation (Pre-condition: Must
	 *        not be null)
	 * 
	 * @param deadline the deadline of the evaluation (Pre-condition: Must not
	 *        be null)
	 * 
	 * @param gracePeriod the amount of time after the deadline within which
	 *        submissions will still be accepted (Pre-condition: Must not be
	 *        null)
	 * 
	 * @throws EvaluationExistsException if an evaluation with the specified
	 *         name exists for the course
	 */
	 ...
	 * 
	 * @param courseID the course ID (Pre-condition: courseID, evaluationName
	 *        and fromStudent must be valid)
	 * 
	 * @param evaluationName the evaluation name (Pre-condition: courseID,
	 *        evaluationName and fromStudent must be valid)
	 * 
	 * @param fromStudent the email of the student giving the feedback
	 *        (Pre-condition: courseID, evaluationName and fromStudent must be
	 *        valid)
	 * 
	...
	public float calculatePointsBumpRatio(String courseID,
		...
		for(Submission s : submissionList) {
			debug.append(s.getPoints()+"-");

			// Exclude unsure and unfilled entries
			if(!((s.getPoints() == - 999) || (s.getPoints() == - 101))) {
		...
		System.out.print("bump: " + debug.toString());
		if(totalPoints == 0)
			return 1;
		else
	 ...
	 * 
	 * @param courseID the course ID (Pre-condition: The courseID and
	 *        evaluationName pair must be valid)
	 * 
	 * @param evaluationName the evaluation name (Pre-condition: The courseID
	 *        and evaluationName pair must be valid)
	 */
			...
			for(Student sy : studentList) {
				if(sx.getTeamName().equals(sy.getTeamName())) {
					submission = new Submission(sx.getEmail(), sy.getEmail(),
							sx.getName(), sy.getName(), courseID,
							evaluationName, sx.getTeamName());
	 ...
	 *        evaluationName pair must be valid)
	 * 
	 * @param name the evaluation name (Pre-condition: The courseID and
	 *        evaluationName pair must be valid)
	 */
	 ...
	 *        evaluationName pair must be valid)
	 * 
	 * @param newInstructions new instructions for the evaluation
	 *        (Pre-condition: Must not be null)
	 * 
	 * @param newCommentsEnabled new status for comments (Pre-condition: Must
	 *        not be null)
	 * 
	 * @param newStart new start date for the evaluation (Pre-condition: Must
	 *        not be null)
	 * 
	 * @param newDeadline new deadline for the evaluation (Pre-condition: Must
	 *        not be null)
	 * 
	 * @param newGracePeriod new grace period for the evaluation (Pre-condition:
	 *        Must not be null)
	 * 
	 ...
	 * email.
	 * 
	 * @param email the email of the student (Pre-condition: The courseID and
	 *        email pair must be valid)
	 * 
	 * @param courseID the course ID (Pre-condition: The courseID and email pair
	 *        must be valid)
	 * 
	 * @param newEmail the new email of the student (Pre-condition: Must not be
	 *        null)
	 */
	 ...
	 * 
	 * @param submissionList the list of submissions to be edited
	 *        (Pre-condition: The submission list must be valid)
	 */
	public void editSubmissions(List<Submission> submissionList) {
		...
		for(Submission s : submissionList) {
			...
			submission.setBumpRation(s.getPointsBumpRatio());
	 ...
	 * @param courseID the course ID (Pre-condition: Must not be null)
	 * 
	 * @param evaluationName the evaluation name (Pre-condition: Must not be
	 *        null)
	 * 
	 ...
	 * 
	 * @param courseID the course ID (Pre-condition: The parameters must be
	 *        valid)
	 * 
	 * @param evaluationName the evaluation name (Pre-condition: The parameters
	 *        must be valid)
	 * 
	 * @param teamName the team name (Pre-condition: The parameters must be
	 *        valid)
	 * 
	 * @param toStudent the email of the target student (Pre-condition: The
	 *        parameters must be valid)
	 * 
	 * @param fromStudent the email of the sending student (Pre-condition: The
	 *        parameters must be valid)
	 * 
	 ...
	 * object.
	 * 
	 * @param studentList the list of students to inform (Pre-condition: The
	 *        parameters must be valid)
	 * 
	 * @param courseID the course ID (Pre-condition: The parameters must be
	 *        valid)
	 ...
	 * Evaluation.
	 * 
	 * @param evaluation the evaluation (Pre-condition: The evaluation and email
	 *        pair must be valid)
	 * 
	 * @param email the email of the student (Pre-condition: The evaluation and
	 *        email pair must be valid)
	 * 
	 ...
	 * 
	 * @param courseID the course ID (Pre-condition: The courseID and name pair
	 *        must be valid)
	 * 
	 * @param name the evaluation name (Pre-condition: The courseID and name
	 *        pair must be valid)
	 */
	 ...
	 * 
	 * @param studentList the list of students to remind (Pre-condition: Must be
	 *        valid)
	 * 
	 * @param courseID the course ID (Pre-condition: Must not be null)
	 * 
