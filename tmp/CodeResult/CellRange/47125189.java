...
import com.extentech.formats.XLS.charts.*;
 ...
 */
						...
						thischart.roundedCorners= xpp.getAttributeValue(0).equals("1");
		            	 ...
		            	 thischart.ooxmlLegend= (com.extentech.formats.OOXML.Legend) com.extentech.formats.OOXML.Legend.parseOOXML(xpp, lastTag, this.wbh).cloneElement();
