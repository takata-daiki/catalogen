...
/**
 * Reads one or several Outlook MSG files and for each of them creates a text
 * file from available chunks and a directory that contains attachments.
 * 
 * @author Bruno Girin
 */
public class Msg2Txt {
    ...
    public Msg2Txt(final String fileName) throws IOException {
     ...
     */
    public void processAttachment(final AttachmentChunks attachment,
        ...
        if (args.length <= 0) {
            ...
            for (int i = 0; i < args.length; i++) {
                try {
                    ...
                    System.err.println("Could not process " + args[i] + ": "
                            + e);
                }
            }
