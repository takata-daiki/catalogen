...
public class Complex implements Cloneable, Serializable {
	 ...
	 * <i><b>Note: </b>
	 * <ul>
	 * <font color="000080">All methods in class <tt>Complex</tt> which
	 * deliver a <tt>Complex</tt> are written such that no intermediate
	 * <tt>Complex</tt> objects get generated. This means that you can easily
	 * anticipate the likely effects on garbage collection caused by your own
	 * coding. </font>
	 * </ul>
	 * </i>
	 * <p>
	...
	public Complex(double re, double im) {
		...
		// if (debug) System.out.println(indent(trace_nesting) + "new Complex,
		// #" + (++objectCount));// !!!
	 ...
	 * <p>
	 * 
	 * @return <tt>true</tt> if either component of the <tt>Complex</tt>
	 *         object is infinite; <tt>false</tt>, otherwise.
	 *         <p>
	 */
	 ...
	 * 
	 * @return <tt>true</tt> if either component of the <tt>Complex</tt>
	 *         object is <tt>NaN</tt>;<tt>false</tt>, otherwise.
	 *         <p>
	 */
	 ...
	 * another, <tt>b</tt>, and yet <tt>a.equals(b, myTolerance)</tt>
	 * returns <tt>true</tt>. Be aware!
	 * <p>
	 * 
	 * @param z
	 ...
	 * <p>
	 * The following Java code example illustrates how to clone, or <i>copy
	 * </i>, a <tt>Complex</tt> number:
	 * <p>
	 * 
	 * <pre>
	 * 
	 ...
	 * 
	 * <p>
	 * In other words, it's Pythagorean distance from the origin ( <i>0 + 0 <b>i
	 * </b> </i>, or zero).
	 * <p>
	 ...
	 * the <tt>arg()</tt> unchanged. Scaling by <i>-1.0 </i> keeps the
	 * magnitude the same, but flips the <tt>arg()</tt> by <tt><b>PI</b></tt>
	 * (180 degrees).
	 * <p>
	 * 
	 * @param scalar
	 ...
	 * <i><b>Note: </b>
	 * <ul>
	 * <tt>Complex</tt> arithmetic in Java never causes exceptions. You have
	 * to deliberately check for overflow, division by zero, and so on, <u>for
	 * yourself </u>.
	 * </ul>
	 * </i>
	 * <p>
	...
	/**
	 * Returns the number <i><b>e </b> </i> "raised to" a <tt>Complex</tt>
	 * power.
	 * 
	 * <p>
	 * 
	 ...
	 * <p>
	 * There are infinitely many solutions, besides the principal solution. If
	 * <b>L </b> is the principal solution of <i>log10(z) </i>, the others are
	 * of the form:
	 * <p>
	 * 
	 * <pre>
	 ...
	 * <p>
	 * There are infinitely many solutions, besides the principal solution. If
	 * <b>A </b> is the principal solution of <i>asinh(z) </i>, the others are
	 * of the form:
	 * <p>
	 * 
	 * <pre>
	 ...
	 * <p>
	 * There are infinitely many solutions, besides the principal solution. If
	 * <b>A </b> is the principal solution of <i>acosh(z) </i>, the others are
	 * of the form:
	 * <p>
	 * 
	 * <pre>
	 ...
	 * <p>
	 * There are infinitely many solutions, besides the principal solution. If
	 * <b>A </b> is the principal solution of <i>atanh(z) </i>, the others are
	 * of the form:
	 * <p>
	 * 
	 * <pre>
	...
	/**
	 * Converts a <tt>Complex</tt> into a
	 * {@link java.lang.String <tt>String</tt>}of the form <tt>(</tt> <i>a
	 * </i> <tt> + </tt> <i>b </i> <tt>i)</tt>.
	 * 
	 * <p>
